...
driver.find_element(By.XPATH, "//input[@placeholder='First']").send_keys("Alex")
driver.find_element(By.XPATH, "//*[@placeholder='Last']").click()
driver.find_element(By.XPATH, "//*[@placeholder='Last']").send_keys("Smile")
