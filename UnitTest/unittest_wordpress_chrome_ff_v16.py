...
class ChromeTest(unittest.TestCase):
    ...
    def test_Chrome_Max_Window(self, faker_class=None):
        ...
        name_field = driver.find_element_by_id('g2-name') #Send Us a Message -> NAME field...
        name_field.clear()
        name_field.send_keys(faker_class.name())
        email_field = driver.find_element_by_name('g2-email') #Send Us a Message -> EMAIL field...
        email_field.clear()
